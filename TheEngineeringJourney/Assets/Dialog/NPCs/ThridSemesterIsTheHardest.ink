...
+ "I'm ready for the challenge. Any advice on tackling the difficulties of the third semester?"
    -> seekSemesterAdvice
...
+ "Intricate puzzles, formidable minions, and a tough boss. Sounds challenging. How can I prepare for the difficulties of the third semester?"
    -> prepareForThirdSemester
+ "I'm up for the challenge. What should I expect from the boss in the third semester?"
...
+ "Resilience and strategic thinking. Got it. Any specific tips on problem-solving or collaboration?"
    -> seekProblemSolvingTips
+ "Defining moment, indeed. I'll make sure to tackle the third semester head-on. Anything else to keep in mind?"
...
+ "Experimentation and seeking assistance. I'll remember that. How important is collaboration in the third semester?"
...
+ "Engaging with peers and leveraging strengths. I'll prioritize collaboration. Anything else to add about the importance of teamwork?"
    -> seekAdditionalSemesterAdvice
+ "I'll make collaboration a priority. Thanks for highlighting its importance in the third semester!"
    -> END
...
+ "Resilience, embracing challenges, and fostering a supportive network. Important reminders. Anything else to prepare for the third semester?"
    -> END
+ "I'll stay resilient and embrace the challenges. Thanks for the additional advice on tackling the third semester!"
    -> END
